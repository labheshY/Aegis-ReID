...
import uuid
import json
from app.core.config import EMBEDDINGS_DIR, BASE_DIR
...
class FaceService:
    ...
    def enroll_multi(self, files: dict, alias: str | None = None):
    ...
    def enroll_single(self, file, alias: str | None = None):
        try:
            data = file.file.read()
            from io import BytesIO
            import numpy as np
